...
export default function ProjectGallery({
  ...
  return (
    <>
      ...
      >
        <DialogContent className="max-w-[95vw] max-h-[90vh] w-full overflow-hidden p-2 sm:max-w-5xl lg:max-w-6xl">
      ...
      <div className="overflow-hidden rounded-md" ref={emblaRef}>
        <div className="flex">
          {images.map((src, i) => (
            <div
              key={src}
              className="relative h-[75vh] max-h-[80vh] w-full shrink-0 grow-0 basis-full"
            >
              <Image
                src={src}
                alt={`${title} - fotoğraf ${i + 1}`}
